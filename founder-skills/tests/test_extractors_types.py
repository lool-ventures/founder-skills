...
from extractors import ExtractionContext, FieldExtraction, SourceSpan  # noqa: E402


class TestSourceSpan:
    def test_extract_returns_slice(self):
    ...
    def test_out_of_bounds_extract_raises(self):
...
class TestFieldExtraction:
    ...
    def test_to_dict_includes_span_when_set(self):
        fe = FieldExtraction(
            name="cap",
            value=20_000_000,
    ...
    def test_to_dict_omits_span_when_absent(self):
        fe = FieldExtraction(name="x", value=1)
        d = fe.to_dict()
        assert "span" not in d

    def test_validate_span_passes_when_quote_matches(self):
    ...
    def test_validate_span_fails_when_quote_differs(self):
    ...
    def test_validate_span_handles_whitespace_differences(self):
    ...
    def test_validate_span_returns_true_when_no_span(self):

...
_VALID_COMMENTARY: dict[str, Any] = {
    ...
    "lenses": {
        "runway": "25 months of runway under base case provides comfortable buffer.",
        "raise_plan": "Target raise of $3M aligns with 24-month runway target.",
        "unit_econ": "LTV/CAC ratio of 4x is strong for seed stage.",
        "stress_test": "Crisis scenario yields 12 months; team should monitor burn closely.",
    },
...
def test_commentary_missing_headline() -> None:
    ...
    bad_commentary = {"lenses": {}, "investor_talking_points": []}

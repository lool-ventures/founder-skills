...
class TestPayToPlayDetection:
    ...
    def test_drafting_language_failure_to_participate_forfeits(self):
        text = (
    ...
    def test_drafting_language_mandatory_conversion(self):
        text = (
    ...
    def test_shadow_series_pattern(self):
        text = (
    ...
    def test_explicit_boolean_override(self):
    ...
    def test_empty_fields_no_false_positive(self):
    ...
    def test_clause_text_field(self):
...
class TestCounselReviewItemIntegration:
    ...
    def test_p2p_emits_counsel_item(self):
        fields = {
